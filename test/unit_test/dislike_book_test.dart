...
import 'package:palm_book_app/features/book/domain/usecases/dislike_book.dart';
...
void main() {
  late DislikeBook usecase;
  late MockBookRepository mockRepository;

  setUp(() {
    mockRepository = MockBookRepository();
    usecase = DislikeBook(mockRepository);
  });
  ...
  test('should return void from repository', () async {
    ...
    when(
      () => mockRepository.dislikeBook(book),
